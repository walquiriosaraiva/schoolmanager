                            ...
                            <div class="mt-3 d-flex align-items-center">
                                ...
                                <div class="col-9 progress">
                                    <div class="progress-bar progress-bar-striped" role="progressbar"
                                         ...
                                         aria-valuemin="0" aria-valuemax="100">{{$maleStudentPercentage}}%
                                    </div>
                                    <div class="progress-bar progress-bar-striped" role="progressbar"
                                         {!!$femaleStudentPercentageStyle!!} aria-valuenow="{{$femaleStudentPercentage}}"
                                         aria-valuemin="0" aria-valuemax="100">{{$femaleStudentPercentage}}%
                                    </div>
                                </div>
                            </div>
                        @endif
                        <div class="row align-items-md-stretch mt-4">
                            <div class="col">
                                <div class="p-3 text-white bg-dark rounded-3">
                                    <h3>Welcome to Schoolmanager!</h3>
                            ...
                            <div class="col">
                                <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                    ...
                                    <p class="text-end">with <i class="bi bi-lightning"></i> <a
                                            href="https://github.com/walquiriosaraiva/schoolmanager" target="_blank"
                                            style="text-decoration: none;">Schoolmanager</a> <i
                                                    ...
                                                    @foreach ($notices as $notice)
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header"
                                                                id="flush-heading{{$notice->id}}">
                                                                <button class="accordion-button collapsed" type="button"
                                                                        data-bs-toggle="collapse"
                                                                        data-bs-target="#flush-collapse{{$notice->id}}"
                                                                        aria-expanded={{($loop->first)?"true":"false"}} aria-controls="flush-collapse{{$notice->id}}">
                                                            ...
                                                            <div id="flush-collapse{{$notice->id}}"
                                                                ...
                                                                <div
                                                                    class="accordion-body overflow-auto">{!!Purify::clean($notice->notice)!!}</div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    @endisset
