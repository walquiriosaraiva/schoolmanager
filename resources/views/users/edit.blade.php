                    ...
                    <div class="col ps-4">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url()->previous()}}">User List</a></li>
                            ...
                            <form class="row g-3" action="{{route('users.update', $user->id)}}" method="POST">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" name="address"
                                           placeholder="634 Main St" required value="{{$user->address}}">
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city"
                                           placeholder="Dhaka..." required value="{{$user->city}}">
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPhone" name="phone"
                                           placeholder="+880 01......" required value="{{$user->phone}}">
                                </div>
                                <div class="col-2">
                                    <label for="inputState" class="form-label">Gender<sup><i
                                                class="bi bi-asterisk text-primary"></i></sup></label>
                                    <select id="inputState" class="form-select" name="gender" required>
                                        <option value="Male" {{($user->gender == 'Male')?'selected':null}}>Male
                                        </option>
                                        <option value="Female" {{($user->gender == 'Female')?'selected':null}}>
                                            Female
                                        </option>
                                    </select>
                                </div>
